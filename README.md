...
Цей проєкт був розроблений для забезпечення зручного  способу відтворення музики на вашому комп'ютері.

Окрім того,цей проєкт допоміг краще зрозуміти, як працювати з подіями, налаштовувати кастомні елементи інтерфейсу, 
...
таких як брати потрібну інформацію із зовнішніх музичниї сервісів.
